...
import { AuthAPI } from "@/lib/auth";              // ✅ FIXED
import { AdminUsersAPI } from "@/lib/adminUsers"; // ✅ REQUIRED
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Select any user and impersonate them.
        </p>
      </div>
      ...
      <Alert className="bg-warning/10 border-warning/30">
        ...
        <AlertDescription>
          All impersonation sessions are logged. Only use for valid support
          actions.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Search any user and impersonate
          </CardDescription>
        </CardHeader>
